...
description: "An engineering reference to post-training methods, their trade-offs, and the failure modes that connect supervised tuning, preference optimization, and distillation."
kind: "reference"
